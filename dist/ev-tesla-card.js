...
`;const _TM={m3:{l:"Model 3",years:[{y:"2023+ (Highland)",base:"MT351",colors:[{v:"PPSW",l:"Pearl White"},{v:"PBSB",l:"Solid Black"},{v:"PPSB",l:"Deep Blue Metallic"},{v:"PN01",l:"Stealth Grey"},{v:"PR01",l:"Ultra Red"}],wheels:[{v:"W38A",l:'18" Photon'},{v:"W39S",l:'19" Nova'}]},{y:"2017\u20132022",colors:[{v:"PPSW",l:"Pearl White"},{v:"PBSB",l:"Solid Black"},{v:"PMNG",l:"Midnight Silver"},{v:"PPSB",l:"Deep Blue Metallic"},{v:"PPMR",l:"Multi-Coat Red"}],wheels:[{v:"W38B",l:'18" Aero'},{v:"W39B",l:'19" Sport'}]}]},my:{l:"Model Y",years:[{y:"2024+ (Juniper)",base:"MTY48",colors:[{v:"PPSW",l:"Pearl White"},{v:"PBSB",l:"Solid Black"},{v:"PPSB",l:"Deep Blue Metallic"},{v:"PN01",l:"Stealth Grey"},{v:"PR01",l:"Ultra Red"}],wheels:[{v:"WY19B",l:'19" Gemini'},{v:"WY20P",l:'20" Induction'}]},{y:"2020\u20132023",colors:[{v:"PPSW",l:"Pearl White"},{v:"PBSB",l:"Solid Black"},{v:"PMNG",l:"Midnight Silver"},{v:"PPSB",l:"Deep Blue Metallic"},{v:"PPMR",l:"Multi-Coat Red"}],wheels:[{v:"WY19B",l:'19" Gemini'},{v:"WY20P",l:'20" Induction'}]}]},ms:{l:"Model S",years:[{y:"2021+",base:"MTS10",colors:[{v:"PPSW",l:"Pearl White"},{v:"PBSB",l:"Solid Black"},{v:"PPSB",l:"Deep Blue Metallic"},{v:"PMNG",l:"Midnight Silver"},{v:"PN00",l:"Quicksilver"},{v:"PR01",l:"Ultra Red"}],wheels:[{v:"WS90",l:'19" Tempest'},{v:"WS10",l:'21" Arachnid'}]},{y:"2012\u20132020",colors:[{v:"PPSW",l:"Pearl White"},{v:"PBSB",l:"Solid Black"},{v:"PMNG",l:"Midnight Silver"},{v:"PPSB",l:"Deep Blue Metallic"},{v:"PPMR",l:"Multi-Coat Red"}],wheels:[{v:"WTAS",l:'19" Slipstream'},{v:"WTSG",l:'21" Turbine'}]}]},mx:{l:"Model X",years:[{y:"2021+",base:"MTX10",colors:[{v:"PPSW",l:"Pearl White"},{v:"PBSB",l:"Solid Black"},{v:"PPSB",l:"Deep Blue Metallic"},{v:"PMNG",l:"Midnight Silver"},{v:"PN00",l:"Quicksilver"},{v:"PR01",l:"Ultra Red"}],wheels:[{v:"WX00",l:'20" Cyberstream'},{v:"WX20",l:'22" Turbine'}]},{y:"2015\u20132020",colors:[{v:"PPSW",l:"Pearl White"},{v:"PBSB",l:"Solid Black"},{v:"PMNG",l:"Midnight Silver"},{v:"PPSB",l:"Deep Blue Metallic"},{v:"PPMR",l:"Multi-Coat Red"}],wheels:[{v:"WT20",l:'20" Slipstream'},{v:"WT22",l:'22" Turbine'}]}]}};class pt extends ct{static properties={_config:{state:!0},_hass:{state:!0},_tsModel:{state:!0},_tsYear:{state:!0},_tsColor:{state:!0},_tsWheel:{state:!0}};static styles=n`
    :host { display: block; }
  ...
  `;constructor(){super(),this._config={},this._tsModel="",this._tsYear="",this._tsColor="",this._tsWheel=""}set hass(t){this._hass=t}setConfig(t){this._config={...t}}_fire(){this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:{...this._config}},bubbles:!0,composed:!0}))}_set(t,e){if(""===e||null==e){const e={...this._config};delete e[t],this._config=e}else this._config={...this._config,[t]:e};this._fire()}_buildTeslaUrl(){const m=this._tsModel,c=this._tsColor,w=this._tsWheel,y=this._tsYear;if(!m||!c)return null;const yd=_TM[m]?.years.find(yr=>yr.y===y);const base=yd?.base;const parts=[base?`$${base}`:null,`$${c}`,w?`$${w}`:null].filter(Boolean);return`https://static-assets.tesla.com/v1/compositor/?model=${m}&view=STUD_3QTR&size=1440&options=${parts.join(",")}&bkba_opt=1`}_entitySelector(t,e,i){const s=i?{entity:{domain:i}}:{entity:{}};return V`
      <ha-selector
        .hass=${this._hass}
        .selector=${s}
        .label=${e}
    ...
    `}render(){return this._hass&&this._config?V`
      ...
      <ha-selector
        ...
        .label=${"Model"}
        .value=${this._tsModel||""}
        @value-changed=${e=>{this._tsModel=e.detail.value;this._tsYear="";this._tsColor="";this._tsWheel=""}}
      ></ha-selector>
      ${this._tsModel?V`
        <ha-selector
          .hass=${this._hass}
          .selector=${{select:{options:_TM[this._tsModel].years.map(y=>({value:y.y,label:y.y})),mode:"dropdown"}}}
          .label=${"Year"}
          .value=${this._tsYear||""}
          @value-changed=${e=>{this._tsYear=e.detail.value;this._tsColor="";this._tsWheel=""}}
        ></ha-selector>
      `:""}
      ${this._tsModel&&this._tsYear?V`
        <ha-selector
          .hass=${this._hass}
          .selector=${{select:{options:(_TM[this._tsModel].years.find(y=>y.y===this._tsYear)||{colors:[]}).colors.map(c=>({value:c.v,label:c.l})),mode:"dropdown"}}}
          .label=${"Color"}
          .value=${this._tsColor||""}
          @value-changed=${e=>{this._tsColor=e.detail.value}}
        ></ha-selector>
        ${((_TM[this._tsModel].years.find(y=>y.y===this._tsYear)||{wheels:[]}).wheels.length>0)?V`
          <ha-selector
            .hass=${this._hass}
            .selector=${{select:{options:(_TM[this._tsModel].years.find(y=>y.y===this._tsYear)||{wheels:[]}).wheels.map(w=>({value:w.v,label:w.l})),mode:"dropdown"}}}
            .label=${"Wheels"}
            .value=${this._tsWheel||""}
      ...
      <mwc-button
        raised
        ?disabled=${!this._tsModel||!this._tsYear||!this._tsColor}
